    ...
    <>
      <form action="" onSubmit={submitHandler} id="user-reg-form">
        <div className="form-container">
          ...
          <div className="mb-3">
            <label htmlFor="formuserage" className="form-label">
              Age
            </label>
            <input
              type="number"
          ...
          <div className="mb-3">
            <input
              ...
              checked={gender === "male"}
            />{" "}
            <span className="form-gender">Male</span>
            <input
              type="radio"
              id="formusergender"
              name="gender"
            ...
            />{" "}
            <span className="form-gender">FeMale</span>
            <input
              type="radio"
              id="formusergender"
              name="gender"
            ...
            />{" "}
            <span className="form-gender">Other</span>
            <br />
          ...
          <div className="mb-3">
            ...
            <p id="para">
              ...
              <Link to="/userlogin" id="login-here">
                Login
              </Link>{" "}
              here
            </p>
